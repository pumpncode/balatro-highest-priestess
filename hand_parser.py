...
def get_rank_token(rank_text: str, is_option: bool = False) -> Optional[int | str | list]:
...
def parse_hand_pattern(raw_text: str):
    ...
    for option in options_iter:
        ...
        possible_values_iter = re.finditer(REGEX_VALUES_GENERIC, option.group(2))
